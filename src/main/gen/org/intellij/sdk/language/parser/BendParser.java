...
import static org.intellij.sdk.language.psi.BendTypes.*;
...
public class BendParser implements PsiParser, LightPsiParser {
  ...
  public static boolean property(PsiBuilder b, int l) {
    ...
    exit_section_(b, l, m, r, false, BendParser::recover_property);
    return r;
  }
  ...
  /* ********************************************************** */
  // item_*
  static boolean bendFile(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "bendFile")) return false;
    while (true) {
      int c = current_position_(b);
      if (!item_(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "bendFile", c)) break;
    }
    return true;
  }
