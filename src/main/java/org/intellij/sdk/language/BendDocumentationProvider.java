...
final class BendDocumentationProvider extends AbstractDocumentationProvider {
  ...
  /**
   * For the Bend Language, we don't have online documentation. However, if your language provides
  ...
  /**
   * Extracts the key, value, file and documentation comment of a Bend key/value entry and returns
   * a formatted representation of the information.
   */
  @Override
  public @Nullable String generateDoc(PsiElement element, @Nullable PsiElement originalElement) {
    if (element instanceof BendProperty) {
      final String key = ((BendProperty) element).getKey();
      final String value = ((BendProperty) element).getValue();
      final String file = SymbolPresentationUtil.getFilePathPresentation(element.getContainingFile());
      final String docComment = BendUtil.findDocumentationComment((BendProperty) element);
  ...
  /**
   * Provides the information in which file the Bend language key/value is defined.
   */
  @Override
  ...
  /**
   * Provides documentation when a Bend Language element is hovered with the mouse.
   */
  @Override
